...
function Cart() {
  ...
  const handleCheckout = () => {
    // Navigate to the Order Completed page
    setCart([]);
    ...
    <div className="max-w-7xl mx-auto p-4 flex flex-col md:flex-row gap-6">
      ...
      <div className="w-full md:w-1/3 bg-white p-6 shadow-lg rounded-md">
        ...
        <button
          ...
          className="mt-4 bg-blue-600 text-white w-full py-2 rounded-md hover:bg-blue-700 transition duration-200"
        >
          Pay it all
        </button>
        <p className="text-center text-xs text-gray-500 mt-2">
          Purchases protected by{' '}
